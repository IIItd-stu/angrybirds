...
public class Level_3 {
    ...
    public void create() {
        if (batch == null) {
            ...
            bird2Texture = new Texture("fatbird.png");
            blockTexture = new Texture("glassbl3.png");
            blockHorizontalTexture = new Texture("Steelh.png");
            pauseButtonTexture = new Texture("pse.png");
            quitButtonTexture = new Texture("quit1.png");
            pigTexture = new Texture("mustachepig.png");
    ...
    private void createPig() {
        ...
        Pig pig1 = new Pig(world, "mustachepig.png", 3);
        pigBody = pig1.createBody(new Vector2(490f / PPM, GROUND_Y + 100f / PPM));
    ...
    private void createBirds() {
        ...
        Bird bird2 = new Bird(world, catapultPosition, "bird.png", 3);
        ...
        Bird bird3 = new Bird(world, catapultPosition, "bird.png", 3);
    ...
    private void createBlocks() {
        ...
        Block block1 = new Block(world, "wb1.png", 1);
        ...
        Block block2 = new Block(world, "wb1.png", 1);
        ...
        Block block3 = new Block(world, "Steelh.png", 3);
    ...
    private void handleEndScreenInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (homeButtonBounds.contains(touch.x, touch.y)) {
                ...
                if (game.level_3 != null) {
                    game.level_3 = new Level_3(game);
                }
            } else if (playAgainButtonBounds.contains(touch.x, touch.y)) {
                // Reset the level fully
                dispose(); // Dispose current resources
                game.level_3 = new Level_3(game); // Create a new instance
                game.level_3.create(); // Reinitialize resources
                game.currentLevel = 3; // Set the current level
            }
        }
    }
    ...
    private void updatePhysics() {
        ...
        if (birdLaunched) {
            if (Gdx.input.isTouched()) {
                Body currentBird = birdBodies[0]; // Current flying bird
                if (currentBird != null) {

                    Vector2 currentVelocity = currentBird.getLinearVelocity();
                    Vector2 boost = currentVelocity.nor().scl(1.2f); // Increase speed (adjust "5f" for intensity)
                    currentBird.applyLinearImpulse(boost, currentBird.getWorldCenter(), true);

                    // Prevent further boosting
                    birdLaunched = false;
                }
            }
    ...
    private void launchBird() {
        ...
        float pullDistance = releaseVector.len();
        float launchForce = Math.min(3f, pullDistance * 1.6f);
